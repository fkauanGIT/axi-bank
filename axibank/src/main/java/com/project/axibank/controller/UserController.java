...
import com.project.axibank.constants.ApplicationConstants;
import com.project.axibank.model.Customer;
import com.project.axibank.model.LoginRequestDTO;
import com.project.axibank.model.LoginResponseDTO;
    ...
    public ResponseEntity<LoginResponseDTO> apiLogin (@RequestBody LoginRequestDTO loginRequest) {
        ...
        if(null != authenticationResponse && authenticationResponse.isAuthenticated()) {
            if (null != env) {
                ...
                jwt = Jwts.builder().issuer("Axi Bank").subject("JWT Token")
