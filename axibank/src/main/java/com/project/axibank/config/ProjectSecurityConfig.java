package com.project.axibank.config;
...
public class ProjectSecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/notices", "/contact", "/error", "/register", "/invalidSession", "/apiLogin", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**").permitAll());
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
        AxiBankUsernamePwdAuthenticationProvider authenticationProvider =
                new AxiBankUsernamePwdAuthenticationProvider(userDetailsService, passwordEncoder);
