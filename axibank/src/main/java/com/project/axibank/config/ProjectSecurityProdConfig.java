...
public class ProjectSecurityProdConfig {
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
        ...
        AxiBankProdUsernamePwdAuthenticationProvider authenticationProvider =
                new AxiBankProdUsernamePwdAuthenticationProvider(userDetailsService, passwordEncoder);
